        ...
        <div className="w-[90%] ml-auto mr-auto mt-11">
            ...
            <div className="grid grid-cols-1 justify-items-center md:grid-cols-3 gap-3 mt-6 mb-6">
                <div className="w-[90%] shadow-lg z-10 h-auto rounded-md py-4 px-3">
                    ...
                    <button className=" text-base mt-2 mb-6 flex px-8 py-2 text-white rounded-md bg-blue-500 md:text-lg md:text-center w-[75%] ml-auto mr-auto  "> Book an appointment </button>
                </div>
                <div className=" w-[90%] shadow-lg z-10 h-auto rounded-md py-4 px-3">
                    ...
                    <button className=" text-base mt-2 mb-6 flex px-8 py-2 text-white rounded-md bg-blue-500 md:text-lg text-center w-[75%] ml-auto mr-auto ">Book an appointment </button>
                </div>
